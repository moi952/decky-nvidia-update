...
# produces packages/decky-nvidia-update-1.zip, -2.zip, -3.zip, ...
#
#   ./package.sh
#
set -euo pipefail
...
NAME="$(basename "$PLUGIN_DIR")"       # decky-nvidia-update
REPO_ROOT="$(dirname "$PLUGIN_DIR")"   # steamos-nvidia-installer
